...
public:
	...
	template <class Arg1>
	CL_DBCommand create_command(const CL_StringRef &format, Arg1 arg1)
	{ return begin_arg(format).set_arg(arg1).get_result(); }

	/// \brief Create database command with 2 input arguments.
	template <class Arg1, class Arg2>
	CL_DBCommand create_command(const CL_StringRef &format, Arg1 arg1, Arg2 arg2)
	{ return begin_arg(format).set_arg(arg1).set_arg(arg2).get_result(); }

	/// \brief Create database command with 3 input arguments.
	template <class Arg1, class Arg2, class Arg3>
	CL_DBCommand create_command(const CL_StringRef &format, Arg1 arg1, Arg2 arg2, Arg3 arg3)
	{ return begin_arg(format).set_arg(arg1).set_arg(arg2).set_arg(arg3).get_result(); }

	/// \brief Create database command with 4 input arguments.
	template <class Arg1, class Arg2, class Arg3, class Arg4>
	CL_DBCommand create_command(const CL_StringRef &format, Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4)
	{ return begin_arg(format).set_arg(arg1).set_arg(arg2).set_arg(arg3).set_arg(arg4).get_result(); }

	/// \brief Create database command with 5 input arguments.
	template <class Arg1, class Arg2, class Arg3, class Arg4, class Arg5>
	CL_DBCommand create_command(const CL_StringRef &format, Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4, Arg5 arg5)
	{ return begin_arg(format).set_arg(arg1).set_arg(arg2).set_arg(arg3).set_arg(arg4).set_arg(arg5).get_result(); }

	/// \brief Create database command with 6 input arguments.
	template <class Arg1, class Arg2, class Arg3, class Arg4, class Arg5, class Arg6>
	CL_DBCommand create_command(const CL_StringRef &format, Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4, Arg5 arg5, Arg6 arg6)
	{ return begin_arg(format).set_arg(arg1).set_arg(arg2).set_arg(arg3).set_arg(arg4).set_arg(arg5).set_arg(arg6).get_result(); }

	/// \brief Create database command with 7 input arguments.
	template <class Arg1, class Arg2, class Arg3, class Arg4, class Arg5, class Arg6, class Arg7>
	CL_DBCommand create_command(const CL_StringRef &format, Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4, Arg5 arg5, Arg6 arg6, Arg7 arg7)
	{ return begin_arg(format).set_arg(arg1).set_arg(arg2).set_arg(arg3).set_arg(arg4).set_arg(arg5).set_arg(arg6).set_arg(arg7).get_result(); }
...
private:
	...
	{
	public:
		DBArg(CL_DBConnection &db, const CL_StringRef &str) : cmd(db.create_command(str)), i(1){}
	...
	DBArg begin_arg(const CL_StringRef &str)
	{
		return DBArg(*this, str);
	}

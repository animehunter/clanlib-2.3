...
enum CL_DisplayDefines
{
	...
	CL_VERTEX_ATTRIB_ARRAY_DIVISOR    = 0x88FE,

	CL_SAMPLE_SHADING                 = 0x8C36,
	CL_MIN_SAMPLE_SHADING_VALUE       = 0x8C37,
	CL_MIN_PROGRAM_TEXTURE_GATHER_OFFSET = 0x8E5E,
	CL_MAX_PROGRAM_TEXTURE_GATHER_OFFSET = 0x8E5F,
	...
	CL_SAMPLE_SHADING_ARB             = 0x8C36,
	CL_MIN_SAMPLE_SHADING_VALUE_ARB   = 0x8C37,

	CL_TEXTURE_CUBE_MAP_ARRAY_ARB     = 0x9009,
	CL_TEXTURE_BINDING_CUBE_MAP_ARRAY_ARB = 0x900A,
	CL_PROXY_TEXTURE_CUBE_MAP_ARRAY_ARB = 0x900B,
	CL_SAMPLER_CUBE_MAP_ARRAY_ARB     = 0x900C,
	CL_SAMPLER_CUBE_MAP_ARRAY_SHADOW_ARB = 0x900D,
	CL_INT_SAMPLER_CUBE_MAP_ARRAY_ARB = 0x900E,
	CL_UNSIGNED_INT_SAMPLER_CUBE_MAP_ARRAY_ARB = 0x900F,

	CL_MIN_PROGRAM_TEXTURE_GATHER_OFFSET_ARB = 0x8E5E,
	CL_MAX_PROGRAM_TEXTURE_GATHER_OFFSET_ARB = 0x8E5F,

	CL_SHADER_INCLUDE_ARB             = 0x8DAE,
	CL_NAMED_STRING_LENGTH_ARB        = 0x8DE9,
	CL_NAMED_STRING_TYPE_ARB          = 0x8DEA,

	CL_COMPRESSED_RGBA_BPTC_UNORM_ARB = 0x8E8C,
	CL_COMPRESSED_SRGB_ALPHA_BPTC_UNORM_ARB = 0x8E8D,
	CL_COMPRESSED_RGB_BPTC_SIGNED_FLOAT_ARB = 0x8E8E,
	CL_COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_ARB = 0x8E8F,
	...
	CL_FIXED                          = 0x140C,
	CL_IMPLEMENTATION_COLOR_READ_TYPE = 0x8B9A,
	CL_IMPLEMENTATION_COLOR_READ_FORMAT = 0x8B9B,
	CL_LOW_FLOAT                      = 0x8DF0,
	CL_MEDIUM_FLOAT                   = 0x8DF1,
	CL_HIGH_FLOAT                     = 0x8DF2,
	CL_LOW_INT                        = 0x8DF3,
	CL_MEDIUM_INT                     = 0x8DF4,
	CL_HIGH_INT                       = 0x8DF5,
	CL_SHADER_COMPILER                = 0x8DFA,
	CL_NUM_SHADER_BINARY_FORMATS      = 0x8DF9,
	CL_MAX_VERTEX_UNIFORM_VECTORS     = 0x8DFB,
	CL_MAX_VARYING_VECTORS            = 0x8DFC,
	CL_MAX_FRAGMENT_UNIFORM_VECTORS   = 0x8DFD,

	CL_PROGRAM_BINARY_RETRIEVABLE_HINT = 0x8257,
	CL_PROGRAM_BINARY_LENGTH          = 0x8741,
	CL_NUM_PROGRAM_BINARY_FORMATS     = 0x87FE,
	CL_PROGRAM_BINARY_FORMATS         = 0x87FF,

	CL_VERTEX_SHADER_BIT              = 0x00000001,
	CL_FRAGMENT_SHADER_BIT            = 0x00000002,
	CL_GEOMETRY_SHADER_BIT            = 0x00000004,
	CL_TESS_CONTROL_SHADER_BIT        = 0x00000008,
	CL_TESS_EVALUATION_SHADER_BIT     = 0x00000010,
	CL_ALL_SHADER_BITS                = 0xFFFFFFFF,
	CL_PROGRAM_SEPARABLE              = 0x8258,
	CL_ACTIVE_PROGRAM                 = 0x8259,
	CL_PROGRAM_PIPELINE_BINDING       = 0x825A,

	CL_MAX_VIEWPORTS                  = 0x825B,
	CL_VIEWPORT_SUBPIXEL_BITS         = 0x825C,
	CL_VIEWPORT_BOUNDS_RANGE          = 0x825D,
	CL_LAYER_PROVOKING_VERTEX         = 0x825E,
	CL_VIEWPORT_INDEX_PROVOKING_VERTEX = 0x825F,
	CL_UNDEFINED_VERTEX               = 0x8260,

	CL_SYNC_CL_EVENT_ARB              = 0x8240,
	CL_SYNC_CL_EVENT_COMPLETE_ARB     = 0x8241,

	CL_DEBUG_OUTPUT_SYNCHRONOUS_ARB   = 0x8242,
	CL_DEBUG_NEXT_LOGGED_MESSAGE_LENGTH_ARB = 0x8243,
	CL_DEBUG_CALLBACK_FUNCTION_ARB    = 0x8244,
	CL_DEBUG_CALLBACK_USER_PARAM_ARB  = 0x8245,
	CL_DEBUG_SOURCE_API_ARB           = 0x8246,
	CL_DEBUG_SOURCE_WINDOW_SYSTEM_ARB = 0x8247,
	CL_DEBUG_SOURCE_SHADER_COMPILER_ARB = 0x8248,
	CL_DEBUG_SOURCE_THIRD_PARTY_ARB   = 0x8249,
	CL_DEBUG_SOURCE_APPLICATION_ARB   = 0x824A,
	CL_DEBUG_SOURCE_OTHER_ARB         = 0x824B,
	CL_DEBUG_TYPE_ERROR_ARB           = 0x824C,
	CL_DEBUG_TYPE_DEPRECATED_BEHAVIOR_ARB = 0x824D,
	CL_DEBUG_TYPE_UNDEFINED_BEHAVIOR_ARB = 0x824E,
	CL_DEBUG_TYPE_PORTABILITY_ARB     = 0x824F,
	CL_DEBUG_TYPE_PERFORMANCE_ARB     = 0x8250,
	CL_DEBUG_TYPE_OTHER_ARB           = 0x8251,
	CL_MAX_DEBUG_MESSAGE_LENGTH_ARB   = 0x9143,
	CL_MAX_DEBUG_LOGGED_MESSAGES_ARB  = 0x9144,
	CL_DEBUG_LOGGED_MESSAGES_ARB      = 0x9145,
	CL_DEBUG_SEVERITY_HIGH_ARB        = 0x9146,
	CL_DEBUG_SEVERITY_MEDIUM_ARB      = 0x9147,
	CL_DEBUG_SEVERITY_LOW_ARB         = 0x9148,

	CL_CONTEXT_FLAG_ROBUST_ACCESS_BIT_ARB = 0x00000004,
	CL_LOSE_CONTEXT_ON_RESET_ARB      = 0x8252,
	CL_GUILTY_CONTEXT_RESET_ARB       = 0x8253,
	CL_INNOCENT_CONTEXT_RESET_ARB     = 0x8254,
	CL_UNKNOWN_CONTEXT_RESET_ARB      = 0x8255,
	CL_RESET_NOTIFICATION_STRATEGY_ARB = 0x8256,
	CL_NO_RESET_NOTIFICATION_ARB      = 0x8261
};

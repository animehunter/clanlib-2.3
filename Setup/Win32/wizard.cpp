...
BOOL Wizard::finish()
{
	...
	if(page_target.target_version == 900)
	{
		...
		generator8.set_platforms(true, page_target.include_x64, page_target.include_sse2, page_target.include_intrinsics, page_target.enable_debug_optimize);
	...
	else if(page_target.target_version == 1000)
	{
		...
		generator10.set_platforms(true, page_target.include_x64, page_target.include_sse2, page_target.include_intrinsics, page_target.enable_debug_optimize);
